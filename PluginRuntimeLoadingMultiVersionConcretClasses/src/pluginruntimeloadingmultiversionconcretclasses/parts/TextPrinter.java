...
public class TextPrinter {
	public String getString() throws Exception {
		...
		URL dataAccessJarURL =  FileLocator.resolve(getURL(dataAccessJarPath));
	    ...
	    URL pluginn= new URL(parentDir);
	    Activator.log("Parent::"+parentDir, null);
	    Activator.log("Path::"+pluginn.getPath()+" File::"+pluginn.getFile(), null);
	    File targetFile = new File(new URL(parentDir+"\\DataAccessLayer.jar").toURI());
	    OutputStream outStream = new FileOutputStream(targetFile);
	    outStream.write(buffer);
	    outStream.flush();
	    outStream.close();
	    
	    dataAccessJarURL = targetFile.toURI().toURL();
		Activator.log("DAURL::"+dataAccessJarURL, null);
